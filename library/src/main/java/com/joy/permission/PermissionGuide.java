...
public class PermissionGuide {
	 ...
	 * 显示提示对话框
	 */
	public static void showTipsDialog(final Activity activity, String[]permissionNames, final DialogInterface.OnDismissListener onDismissListener) {

		StringBuilder sb = new StringBuilder();
		sb.append(activity.getString(R.string.tip_msg));
		sb.append("\\n");
		List<String> deniedPermissions = PermissionManager.getInstance().getDeniedPermissions(activity, permissionNames);
		sb.append("\\n");
